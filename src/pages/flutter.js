                    ...
                    <section class="text-gray-400 bg-gray-900 body-font overflow-hidden">
                        <div class="container px-5 py-24 mx-auto">
                            ...
                            <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                                ...
                                <h1 class="text-white text-3xl title-font font-medium mb-4">Mobile App with Flutter</h1>
                                <div class="flex mb-4">
                                ...
                                <span class="ml-auto text-white">2 Operating System</span>
                                </div>
                                <div class="flex border-t border-gray-800 py-2">
                                <span class="text-gray-500">Type</span>
                                <span class="ml-auto text-white">Functional</span>
                                </div>
                                ...
                                <div class="flex">
                                <span class="title-font font-medium text-2xl text-white">$25.00/Hr</span>
