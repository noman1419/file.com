        ...
        <div>
            ...
            <section class="text-gray-400 bg-gray-900 body-font relative">
                <div class="container px-5 py-24 mx-auto">
                    ...
                    <h1 class="sm:text-3xl text-2xl font-bold title-font mb-4 text-white">Contact Us</h1>
                    <p class="lg:w-2/3 mx-auto leading-relaxed text-sm">Reach Out: Contact us through our form for any support. We{"'"}ll reply promptly.</p>
                    </div>
                    ...
                    <div class="flex flex-wrap -m-2">
                        ...
                        <div class="p-2 w-full">
                        <button class="flex mx-auto text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">Send</button>
                        </div>
                        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-800 text-center">
                        <a class="text-blue-400 text-decoration-none">NomanShahid1419@email.com</a>
                        <br/>
